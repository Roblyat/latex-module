...
\begin{figure}[H]
    ...
    \caption{Train Loss / Validation MSE DeLaN median+IQR across seeds by hyper set}
...
\begin{figure}[H]
    ...
    \caption{Scatter validation RMSE vs validation RMSE IQR}
...
\begin{figure}[H]
    ...
    \caption{Scatter validation RMSE vs test RMSE}
...
\begin{figure}[H]
    ...
    % \caption{i_motor RMSE per joint by hyper set}
...
\begin{figure}[H]
    ...
    % \caption{lstm validation loss vs i_motor RMSE total}
...
\begin{figure}[H]
    ...
    \caption{Overfit ration by feature mode}
...
\begin{figure}[H]
    ...
    % \caption{i_motor residual RMSE by feature mode}
...
\begin{figure}[H]
    ...
    % \caption{i_motor residual RMSE by window length}
...
\begin{figure}[H]
    ...
    % \caption{i_motor residual GT vs residual prediction}
...
\begin{figure}[H]
    ...
    \caption{Best pipeline total RMSE per joint}
