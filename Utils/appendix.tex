...
\chapter{Query Categories-Index Terms}~\label{app:query_categories}
...
% \caption[]{Overview of selected references by category, source and citation count (continued)}\\
% \toprule
% \textbf{Reference} & \textbf{Cite} & \textbf{Year} & \textbf{Database} & \textbf{Citations} \\
% \midrule
% \endhead
...
% \clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{DeLaN parameterisation and friction model}~\label{ch:appendix_delan}
...
\section{Inertia subnetwork}~\label{sec:app_inertia}
...
\section{Potential and gravity subnetworks}~\label{sec:app_potential}
...
\section{Friction subnetwork}~\label{sec:app_friction}
...
\section{Resulting DeLaN inverse-dynamics map}~\label{sec:app_delan_map}
